...
/**
 * Application-wide configuration for security beans.
 * This class provides the beans for medisync:
 * - UserDetailsService: How to load users from database
 * - PasswordEncoder: How to hash/verify passwords
